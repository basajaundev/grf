...
int main(int argc, char *argv[]) {
  ...
  if (grf_version() < (0x11c)) {  // 0.1.28
    QMessageBox::warning(NULL, "GrfBuilder", "I need at least libgrf v0.1.28 to run. Make sure you have the last one installed.",
...
/*
    ...
    tab_sel->setTabText(tab_sel->indexOf(grf_allfiles), QApplication::translate("main_window", "All files", 0,
   QApplication::UnicodeUTF8));
    view_filestree->headerItem()->setText(0, QApplication::translate("main_window", "Filename", 0,
   QApplication::UnicodeUTF8));
    view_filestree->headerItem()->setText(1, QApplication::translate("main_window", "File size", 0,
   QApplication::UnicodeUTF8));
    ...
    __item4->setText(0, QApplication::translate("main_window", "\355\225\234\352\265\255\354\226\264", 0,
   QApplication::UnicodeUTF8));
    __item4->setText(1, QApplication::translate("main_window", "", 0, QApplication::UnicodeUTF8));
    tab_sel->setTabText(tab_sel->indexOf(grf_treeview), QApplication::translate("main_window", "Tree view", 0,
   QApplication::UnicodeUTF8));
